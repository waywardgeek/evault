...
function LoginContent() {
  ...
  // Get callback URL from query parameters, default to vault
      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Secure authentication with Google or Apple
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                disabled={isLoading}
                className="group relative w-full flex justify-center py-3 px-4 border border-gray-300 text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 transition-colors"
              >
                {isLoading ? (
                  <span className="flex items-center">
